sap.ui.define([
    ...
    return BaseController.extend("kpmg.custom.testingTile.TestingTile.TestingTile.controller.InspectionView", {
        ...
        onAfterRendering: function () {
            ...
            if(!oNavContainer){
                oNavContainer = that.getView().byId("navContainerInspection");
