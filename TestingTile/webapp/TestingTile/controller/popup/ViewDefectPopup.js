sap.ui.define([
    ...
    return Dialog.extend("kpmg.custom.testingTile.TestingTile.TestingTile.controller.popup.ViewDefectPopup", {
         ...
         open: function (oView, oController, defect) {
            ...
            that._initDialog("kpmg.custom.testingTile.TestingTile.TestingTile.view.popup.ViewDefectPopup", oView, that.ViewDefectModel);
            
            var infoModel = that.MainPODcontroller.getInfoModel();
            const project = infoModel.getProperty("/selectedFinalCollaudoRow/project") || "";
            const sfc = infoModel.getProperty("/selectedFinalCollaudoRow/sfc") || "";
            const order = infoModel.getProperty("/selectedFinalCollaudoRow/order") || "";
            
            that.ViewDefectModel.setProperty("/defect", that.defectSelected);
            that.ViewDefectModel.setProperty("/project", project);
            that.ViewDefectModel.setProperty("/sfc", sfc);
            that.ViewDefectModel.setProperty("/order", order);
